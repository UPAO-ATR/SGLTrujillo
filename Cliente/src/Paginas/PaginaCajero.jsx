...
function NuevaSolicitud({ alCompletar }) {
  ...
  if (Tramite && !ResultadoPago) return <Seccion titulo={`Pago de ${Tramite.codigo}`}><Aviso>{Mensaje}</Aviso><PagoDemostrativo codigo={Tramite.codigo} alPagar={Pagar} /></Seccion>;
